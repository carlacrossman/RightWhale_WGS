...
#	- file 'HiC_scaffold_8_NARW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/NARW/HiC_scaffold_8/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/NARW_workspace/scaff8/ \
    -L HiC_scaffold_8 \
    --sample-name-map ~/scratch/gvcf/NARW/HiC_scaffold_8/HiC_scaffold_8_NARW_samples \
