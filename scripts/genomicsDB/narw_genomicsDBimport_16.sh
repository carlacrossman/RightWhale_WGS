...
#	- file 'HiC_scaffold_16_NARW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/NARW/HiC_scaffold_16/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/NARW_workspace/scaff16/ \
    -L HiC_scaffold_16 \
    --sample-name-map ~/scratch/gvcf/NARW/HiC_scaffold_16/HiC_scaffold_16_NARW_samples \
