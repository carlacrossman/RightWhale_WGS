...
#	- file 'HiC_scaffold_20_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_20/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff20/ \
    -L HiC_scaffold_20 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_20/HiC_scaffold_20_SRW_samples \
