...
#	- file 'HiC_scaffold_1_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_1/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff1/ \
    -L HiC_scaffold_1 \
