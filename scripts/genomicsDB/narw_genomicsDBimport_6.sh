...
#	- file 'HiC_scaffold_6_NARW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/NARW/HiC_scaffold_6/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/NARW_workspace/scaff6/ \
    -L HiC_scaffold_6 \
    --sample-name-map ~/scratch/gvcf/NARW/HiC_scaffold_6/HiC_scaffold_6_NARW_samples \
