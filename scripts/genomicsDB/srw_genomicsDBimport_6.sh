...
#	- file 'HiC_scaffold_6_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_6/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff6/ \
    -L HiC_scaffold_6 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_6/HiC_scaffold_6_SRW_samples \
