...
#	- file 'HiC_scaffold_14_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_14/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff14/ \
    -L HiC_scaffold_14 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_14/HiC_scaffold_14_SRW_samples \
