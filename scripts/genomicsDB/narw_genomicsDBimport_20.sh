...
#	- file 'HiC_scaffold_20_NARW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/NARW/HiC_scaffold_20/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/NARW_workspace/scaff20/ \
    -L HiC_scaffold_20 \
    --sample-name-map ~/scratch/gvcf/NARW/HiC_scaffold_20/HiC_scaffold_20_NARW_samples \
