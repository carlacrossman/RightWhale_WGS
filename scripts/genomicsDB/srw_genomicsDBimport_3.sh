...
#	- file 'HiC_scaffold_3_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_3/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff3/ \
    -L HiC_scaffold_3 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_3/HiC_scaffold_3_SRW_samples \
