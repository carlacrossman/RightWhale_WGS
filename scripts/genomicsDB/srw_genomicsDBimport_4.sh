...
#	- file 'HiC_scaffold_4_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_4/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff4/ \
    -L HiC_scaffold_4 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_4/HiC_scaffold_4_SRW_samples \
