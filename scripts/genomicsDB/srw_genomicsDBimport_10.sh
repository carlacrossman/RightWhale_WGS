...
#	- file 'HiC_scaffold_10_SRW_samples' that specifies files and samples
#	- This was run as an array job with a job for each scaffold
#
# To be run from: ~/scratch/gvcf/SRW/HiC_scaffold_10/
#
##########################################

java -Xms20G -Xmx20G -jar ${GATK_JAR} GenomicsDBImport \
    --genomicsdb-workspace-path ~/scratch/genomicsDB/SRW_workspace/scaff10/ \
    -L HiC_scaffold_10 \
    --sample-name-map ~/scratch/gvcf/SRW/HiC_scaffold_10/HiC_scaffold_10_SRW_samples \
