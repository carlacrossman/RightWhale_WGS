...
# 
# This code uses the srw_fastq_list input file to extract 
...
#	- file 'srw_fastq_list' that specifies samples by lane to be sorted
...
java -Xmx45G -jar ${GATK_JAR} SortSam \
